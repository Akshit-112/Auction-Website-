...
Congratulations! The auction for your item '$itemName', has
completed with a winning bid of $currency $winnerAmt bidded by
{$winnerName}!
...
It is recommended that you contact the winning bidder within 3
days.
